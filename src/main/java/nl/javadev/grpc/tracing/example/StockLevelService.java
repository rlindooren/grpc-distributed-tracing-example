...
public class StockLevelService extends StockLevelServiceImplBase {
     ...
     */
    private Optional<Integer> getStockLevelFromWarehouseManagementSystem(final String productId) {
        // TODO span

        SleepUtil.sleepRandomly(20);
        // Wrap it in an option
        // it's meaningless for this code, but in a real system the requested product might not have stock information
